...
<div class="border border-dashed border-gray-300 p-1">
	<form method="POST" action="?/createform" use:enhance>
		...
		<div class="rounded-md px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
			...
			<input class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" type="text" id="formName" name="formName" required />
		</div>
		<div class="h-1" />
		<div class="rounded-md px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
			<label class="block text-xs font-medium text-gray-900" for="formDescription">Description</label>
			<textarea class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" id="formDescription" name="formDescription" />
		</div>
		<div class="h-1" />
		<button
